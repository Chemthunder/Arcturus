...
public interface ArcturusEntities {
    ...
    EntityType<CreatureEntity> CREATURE = createEntity("creature", FabricEntityTypeBuilder.<CreatureEntity>create(SpawnGroup.MISC, CreatureEntity::new).disableSaving().dimensions(EntityDimensions.changing(0.2f, 0.2f)).build());
